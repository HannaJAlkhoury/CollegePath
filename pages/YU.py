...
st.set_page_config(page_title="College Path- جامعة اليرموك", page_icon=icon, layout= "wide")
def cost(unicost):
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=12qU32ByTRJPjHFZeB_sOIgRJ1okzp_k&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'> جامعة اليرموك </h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/YU.jpg")
            st.image(image)
        with r:
            st.write("<a href='https://site.ypu.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/Yarmouk+Private+University/@33.0886803,36.2783146,17z/data=!3m1!4b1!4m6!3m5!1s0x15196a8b6c2c1465:0xb6e143f6f6ae35cf!8m2!3d33.0886759!4d36.282928!16s%2Fm%2F0t53gr6?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 23 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة اليرموك الخاصة هي جامعة سورية خاصة تعتمد أحدث النظم العالمية في مجال التعليم وتتبادل الخبرات مع مؤسسات وجامعات عربية وعالمية، تقع على الطريق الدولي بين دمشق ودرعا وعلى مسافة 45 كم من مدينة دمشق وتتوسط بموقعها أربع محافظات هي درعا والسويداء ودمشق والقنيطرة </h5>" , unsafe_allow_html=True)  
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/Yarmouk.Private.University/' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.youtube.com/channel/UCVxhmjeQstsadvisI4yiWjg' style='text-align: right; color: #f02020; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  YouTube-يوتيوب 🟥 </a>", unsafe_allow_html=True)
...
<style>
        ...
        for loop in range(36):
            ...
            allfees.append(l)
        list=[]
        majors=["الصيدلة","التصميم الداخلي","الهندسة المدنية","الهندسة المعلوماتية","العلوم الإدارية","هندسة العمارة"]
    ...
    if selectuni=="كليات الجامعة": 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية هندسة المعلوماتية والاتصالات </h5>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الصيدلة </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الهندسة المدنية والبيئية </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الهندسة المعمارية </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية العلوم الإدارية والمالية </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية التصميم والفنون التطبيقية </h5>" , unsafe_allow_html=True)  