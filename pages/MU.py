...
st.set_page_config(page_title="College Path- جامعة المنارة", page_icon=icon, layout= "wide")
def cost(unicost):
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=1fcwcPkafBDbsfXoC4GFzLykfQfv_zt4&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'> جامعة المنارة الخاصة </h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/MU.jpg")
            st.image(image)
        with r:
            st.write("<a href='http://manara.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/Manara+University/@35.5520613,35.7639275,17.5z/data=!4m10!1m2!2m1!1z2KzYp9mF2LnYqSAg2KfZhNmF2YbYp9ix2Kkg2KfZhNiu2KfYtdip!3m6!1s0x1526ae6dbc733e97:0x71c8aac799f6f05c!8m2!3d35.5520932!4d35.7661869!15sCifYrNin2YXYudipICDYp9mE2YXZhtin2LHYqSDYp9mE2K7Yp9i12KmSARJwcml2YXRlX3VuaXZlcnNpdHngAQA!16s%2Fg%2F11hmswp0qj?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 17 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة المنارة، هي جامعة سورية مقرها مدينة اللاذقية، تأسست سنة 2016 ميلادي </h5>" , unsafe_allow_html=True)  
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/ManaraUniv/' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
...
<style>
        ...
        for loop in range(41):
            ...
            allfees.append(l)
        list=[]
        majors=["علاج وظيفي","طب الأسنان","الصيدلة","هندسة الروبوت","الهندسة المدنية","الهندسة المعلوماتية","هندسة الميكاترونيكس","إدارة الأعمال","هندسة العمارة","فنون أداء"]
    ...
    if selectuni=="المنشآت التابعة":
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'> خدمة السكن الجامعي متوفرة للطالبات فقط ولموظفي ومدرسي الجامعة </h5>" , unsafe_allow_html=True)
    if selectuni=="كليات الجامعة": 
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية علوم الصحة </h5>" , unsafe_allow_html=True) 
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الإدارة الأعمال </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية فنون الأداء </h5>" , unsafe_allow_html=True)  