...
st.set_page_config(page_title="College Path- جامعة القلمون", page_icon=icon, layout= "wide")
def cost(unicost):
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=1KCcPz9QoPYdOiqaE4TrqjsvHmA-CtqU&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'> جامعة القلمون </h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/KU.jpg")
            st.image(image)
        with r:
            st.write("<a href='http://www.uok.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/%D9%85%D9%83%D8%AA%D8%A8+%D8%AC%D8%A7%D9%85%D8%B9%D8%A9+%D8%A7%D9%84%D9%82%D9%84%D9%85%D9%88%D9%86%E2%80%AD/@33.5164949,36.2885222,17z/data=!3m1!4b1!4m6!3m5!1s0x1518e747924f8acd:0xad87d9cba7151370!8m2!3d33.5164949!4d36.2885222!16s%2Fg%2F11p14d8bwc?entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> موقع مكتب الجامعة في دمشق  🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 11 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة القلمون الخاصة هي جامعة سورية خاصة مقرها مدينة دير عطية في محافظة ريف دمشق. أُسِّسَت عام 2002 وبدأ التدريس فيها عام 2003 </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> يقع حرم الجامعة على الطريق الدولي الواصل بي دمشق وحمص ويتوسط أربع مدن هي قارة، دير عطية، النبك ويبرود. تبلغ مساحة أرض الحرم الجامعي قرابة 500 دونم (500.000 م2) مضاف إليها منطقة توسع إضافية تبلغ حوالي 500 دونم أخرى </h5>" , unsafe_allow_html=True) 
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.youtube.com/channel/UCSsmPSWV8YyqedHDvTMnigA' style='text-align: right; color: #f02020; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  YouTube-يوتيوب 🟥 </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/kalamoonofficial' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
    if selectuni=="الرسوم الدراسية":
        ...
        for loop in range(37):
            ...
            allfees.append(l)
        list=[]
        majors=["طب الأسنان","الصيدلة","التصميم الغرافيكي","الهندسة المدنية","الهندسة المعلوماتية","الحقوق","هندسة تقانة المعلومات","التمويل والمصارف","هندسة العمارة","هندسة الميكاترونيكس","الطب البشري"]
    ...
    if selectuni=="المنشآت التابعة":
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'>مستشفى المدينة الطبية</h5>" , unsafe_allow_html=True)
...
\nكلية العلوم التطبيقية    
        ...
        st.markdown("<h4 style='text-align: right; color: #0070C0;'>: علوم إنسانية وإدارية </h4>" , unsafe_allow_html=True)  
        st.write("""
