...
st.set_page_config(page_title="College Path- جامعة قاسيون", page_icon=icon, layout= "wide")
def cost(unicost):
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=1M9z3ICM50W4XJVvijhjfoUQWaLs5jAk&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'> جامعة قاسيون الخاصة </h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/QAU.jpg")
            st.image(image)
        with r:
            st.write("<a href='https://qpu.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/Qassioun+University/@33.0750659,36.2807291,16.25z/data=!4m14!1m7!3m6!1s0x15196b9eaaafdba1:0x94790c941c7f67f1!2z2KzYp9mF2LnYqSDZgtin2LPZitmI2YYg2KfZhNiu2KfYtdip!8m2!3d33.070971!4d36.2778204!16s%2Fg%2F11vj2n41pl!3m5!1s0x15196a67fad9e1eb:0x9f5536cb54af9390!8m2!3d33.075031!4d36.28414!16s%2Fg%2F11dxm9dmc0?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 27 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة قاسيون الخاصة للعلوم والتكنولوجيا، هي جامعة سورية خاصة، تقع في منطقة جباب على الطريق الدولي بين سورية والأردن (أوتوستراد دمشق - درعا) قرب بلدة كريم حيث تبعد 50 كم عن دمشق </h5>" , unsafe_allow_html=True)  
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/QasyounPrivateUniversity/' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.youtube.com/channel/UCl8Wh2nfJGnoSNjBFezQs2w/featured?view_as=subscriber' style='text-align: right; color: #f02020; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  YouTube-يوتيوب 🟥 </a>", unsafe_allow_html=True)
        st.write("<a href='https://twitter.com/QasyounU' style='text-align: right; color: #020209; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  X (Twitter) - إكس (تويتر) ✖ </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.instagram.com/qpu.edu.sy/' style='text-align: right; color: #d0d010; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Instagram-إنستاغرام 🟨 </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.linkedin.com/in/qasyounprivateuniversity/' style='text-align: right; color: #0010d0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  LinkedIN-لينكدإن 🔷 </a>", unsafe_allow_html=True)
...
<style>
        ...
        for loop in range(45):
            ...
            allfees.append(l)
        list=[]
        majors=["طب الأسنان","الصيدلة","هندسة الاتصالات","الهندسة المعلوماتية","اللغة الإنكليزية","المحاسبة","إدارة الأعمال","هندسة العمارة","التمويل","التسويق"]
    ...
    if selectuni=="كليات الجامعة": 
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية هندسة الاتصالات </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الهندسة المعلوماتية </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الهندسة المعمارية </h5>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الإدارة والإقتصاد </h5>" , unsafe_allow_html=True) 
        st.markdown("<h5 style='text-align: right; color: #000000;'> كلية الآداب </h5>" , unsafe_allow_html=True)  