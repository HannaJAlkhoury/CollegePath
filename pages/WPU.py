...
st.set_page_config(page_title="College Path- الجامعة الوطنية الخاصة", page_icon=icon, layout= "wide")
def cost(unicost):
...
with st.sidebar:
    ...
    select = option_menu(
        menu_icon="bank2",
        menu_title="الجامعة الوطنية الخاصة",
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=1HJq5N8SYc96x7YlWZcxqwpuspP6HziE&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'>الجامعة الوطنية الخاصة</h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/WPU.jpg")
            st.image(image)
        with r:
            st.write("<a href='http://www.wpu.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/Al-Wataniya+Private+University/@34.9704359,36.7508102,17z/data=!4m6!3m5!1s0x15237077a8817b51:0x37c21840ee3ae017!8m2!3d34.9693062!4d36.7516471!16s%2Fm%2F0pcw443?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 18 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> الجامعة الوطنية الخاصة، هي جامعة خاصة في سوريا أُسِّسَت في العام 2007. تقع في محافظة حماة، الأوتوستراد الدولي (حماة - حمص) غور العاصي </h5>" , unsafe_allow_html=True)  
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.youtube.com/channel/UCHmFO72wWNaaaI08gYPxgMQ' style='text-align: right; color: #f02020; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  YouTube-يوتيوب 🟥 </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/AlWataniya.Private.University' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
        st.write("<a href='https://twitter.com/AlUniversty' style='text-align: right; color: #020209; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  X (Twitter) - إكس (تويتر) ✖ </a>", unsafe_allow_html=True)
        st.write("<a href='https://www.instagram.com/wataniyapu/' style='text-align: right; color: #d0d010; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Instagram-إنستاغرام 🟨 </a>", unsafe_allow_html=True)
    if selectuni=="الرسوم الدراسية":
        ...
        for loop in range(44):
            ...
            allfees.append(l)
        list=[]
        majors=["طب الأسنان","الصيدلة","هندسة الحاسوب","الهندسة المدنية","العلوم الإدارية","هندسة الاتصالات","هندسة العمارة"]
        ...
        st.markdown("<h5 style='text-align: right; color: #000000;'> بين 750 و900 ألف ليرة سورية شهرياً باستخدام نقل الجامعة </h5>" , unsafe_allow_html=True)    
    if selectuni=="المنشآت التابعة":
        st.markdown("<h3 style='text-align: right; color: #00B0F0;'> السكن الجامعي </h3>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'>   الجامعة توفر خدمة السكن الجامعي لطلابها </h5>" , unsafe_allow_html=True)
    if selectuni=="كليات الجامعة":
        ...
        """
        st.markdown("<h4 style='text-align: right; color: #000000;'> كلية الإدارة والعلوم المالية </h4>" , unsafe_allow_html=True)
        ...
        st.markdown("<h4 style='text-align: right; color: #000000;'> كلية هندسة العمارة </h4>" , unsafe_allow_html=True)  