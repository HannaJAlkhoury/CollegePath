...
with st.sidebar:
     ...
     st.markdown('''<div style="background-color:#FFFFFF ; padding:10px;border-radius:9px;">
                    ...
                    <h6></h6>
                    <a href="#" target="_self" class=".st-emotion-cache-g2ydmt" style="color:#FFFFFF; background-color:#00B0F0; display: inherit; border-radius:6px; padding:7px; margin:3;text-align: right;  font-weight: 900; font-size: 1.1rem; text-decoration: none; "> البحث عن الجامعة ‎ ‎<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-bank2" viewBox="0 0 20 20"><path d="M8.277.084a.5.5 0 0 0-.554 0l-7.5 5A.5.5 0 0 0 .5 6h1.875v7H1.5a.5.5 0 0 0 0 1h13a.5.5 0 1 0 0-1h-.875V6H15.5a.5.5 0 0 0 .277-.916zM12.375 6v7h-1.25V6zm-2.5 0v7h-1.25V6zm-2.5 0v7h-1.25V6zm-2.5 0v7h-1.25V6zM8 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2M.5 15a.5.5 0 0 0 0 1h15a.5.5 0 1 0 0-1z"/><svg></a>
                    <h6></h6>
...
if selectuni=="الجامعات الحكومية":
     ...
     with l1:
          ...
          with l11:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق وريفها، درعا، القنيطرة، السويداء </h5>" , unsafe_allow_html=True)
          with r11:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 1 </h5>" , unsafe_allow_html=True)      
     ...
     with l2:
          ...
          with l21:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب وإدلب </h5>" , unsafe_allow_html=True)
          with r21:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 3 </h5>" , unsafe_allow_html=True)      
     ...
     with r3:
          ...
          st.image(TUimage)
     with l3:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة اللاذقية </h2>" , unsafe_allow_html=True)
          l31,r31=st.columns(2)
          with l31:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: اللاذقية  </h5>" , unsafe_allow_html=True)
          with r31:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 2 </h5>" , unsafe_allow_html=True)      
     ...
     with r4:
          ...
          st.image(BUimage)
     with l4:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة حمص </h2>" , unsafe_allow_html=True)
          l41,r41=st.columns(2)
          with l41:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حمص  </h5>" , unsafe_allow_html=True)
          with r41:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 5 </h5>" , unsafe_allow_html=True)      
     ...
     with l5:
          ...
          with l51:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: طرطوس  </h5>" , unsafe_allow_html=True)
          with r51:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 13 </h5>" , unsafe_allow_html=True)      
     ...
     with l6:
          ...
          with l61:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حماه  </h5>" , unsafe_allow_html=True)
          with r61:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 15 </h5>" , unsafe_allow_html=True)      
     ...
     l6, r6=st.columns((4,1))
     with r6:
          IDUimage= Image.open("images/IDU.webp")
          st.image(IDUimage)
     with l6:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة إدلب </h2>" , unsafe_allow_html=True)
          l61,r61=st.columns(2)
          with l61:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: إدلب  </h5>" , unsafe_allow_html=True)
          with r61:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 25 </h5>" , unsafe_allow_html=True)      
     ...
     with l7:
          ...
          with l71:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: فقط للطلاب المؤهلين للتقديم على مفاضلة الموقع الشرقية   </h5>" , unsafe_allow_html=True)
               notbutton= st.button(" مفاضلة الموقع الشرقية")  
               if notbutton == True:  
                    ...
                    st.markdown("<h5 style='text-align: right; color: #00B0F0;'>  نحن ننصح أبناء الموقع الشرقية بإضافة طلبات الموقع الشرقية إلى مفاضلتهم لأنها تزيد من فرص قبولهم </h5>", unsafe_allow_html=True)
                    litteralynotbutton=st.button("⏏")
          with r71:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 22 </h5>" , unsafe_allow_html=True)      
     ...
     with l8:
          ...
          with r81:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 8 </h5>" , unsafe_allow_html=True)      
     ...
     with l10:
          ...
          with l101:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق و حلب  </h5>" , unsafe_allow_html=True)
          with r101:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 4 </h5>" , unsafe_allow_html=True)      
     ...
     with l10:
          ...
          with l101:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق و حلب  </h5>" , unsafe_allow_html=True)
          with r101:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 20 </h5>" , unsafe_allow_html=True)      
     ...
     st.write("---")
     st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> المعهد العالي للفنون المسرحية </h2>" , unsafe_allow_html=True)
     l101,r101=st.columns(2)
     with r101:
          st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق </h5>" , unsafe_allow_html=True)
     with l101:
          st.markdown("<h5 style='text-align: right; color: #000000;'> المعهد العالي للفنون المسرحية هو مؤسسة جامعية تُعِد الطلبة لنيل درجة الإجازة في الفنون المسرحية في أقسام اختصاصية متعددة، كما يوفر فرصاً للدراسات العليا وللبحث العلمي في الدراسات المسرحية </h5>" , unsafe_allow_html=True)
     st.write("---")
     st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> المعهد العالي للموسيقا </h2>" , unsafe_allow_html=True)
     l101,r101=st.columns(2)
     with r101:
          st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق </h5>" , unsafe_allow_html=True)
     with l101:
          st.markdown("<h5 style='text-align: right; color: #000000;'> تأسس المعهد العالي للموسيقا بدمشق عام 1990 ومقره في ساحة الأمويين، وهو المكان الأكاديمي الوحيد الذي يخرج موسيقيين في سوريا ويضاف إليه كلية التربية الموسيقية في حمص. </h5>" , unsafe_allow_html=True)
     st.write("---")
     st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> المعهد العالي للفنون السينمائية </h2>" , unsafe_allow_html=True)
     l101,r101=st.columns(2)
     with r101:
          st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق </h5>" , unsafe_allow_html=True)
     with l101:
...
if selectuni=="الجامعات الخاصة":
     ...
     with l1:
          ...
          l11,r11=st.columns(2)
          with l11:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: ريف دمشق </h5>" , unsafe_allow_html=True)
          with r11:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 11 </h5>" , unsafe_allow_html=True)      
     ...
     with l2:
          ...
          with r21:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 7 </h5>" , unsafe_allow_html=True)      
     ...
     with l3:
          ...
          with l31:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: أوتوستراد دمشق-درعا </h5>" , unsafe_allow_html=True)
          with r31:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 6 </h5>" , unsafe_allow_html=True)      
     ...
     with l4:
          ...
          with l41:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: أوتوستراد دمشق-درعا </h5>" , unsafe_allow_html=True)
          with r41:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 10 </h5>" , unsafe_allow_html=True)      
     ...
     with l5:
          ...
          with l51:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حمص  </h5>" , unsafe_allow_html=True)
          with r51:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 12 </h5>" , unsafe_allow_html=True)      
     ...
     with l6:
          ...
          with l61:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: أوتوستراد دمشق-درعا </h5>" , unsafe_allow_html=True)
          with r61:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 32 </h5>" , unsafe_allow_html=True)      
     ...
     with l7:
          ...
          with l71:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: أوتوستراد دمشق-درعا </h5>" , unsafe_allow_html=True)
          with r71:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 18 </h5>" , unsafe_allow_html=True)      
     ...
     with l8:
          ...
          with l81:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حماه </h5>" , unsafe_allow_html=True)
          with r81:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 23 </h5>" , unsafe_allow_html=True)      
     ...
     with l9:
          ...
          l91,r91=st.columns(2)
          with l91:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب والحسكة  </h5>" , unsafe_allow_html=True)
          with r91:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 29 </h5>" , unsafe_allow_html=True) 
     ...
     with l10:
          ...
          l101,r101=st.columns(2)
          with l101:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: الرقة، حلب، دمشق  </h5>" , unsafe_allow_html=True)
          with r101:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 24 </h5>" , unsafe_allow_html=True) 
     ...
     with l11:
          ...
          with l111:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب </h5>" , unsafe_allow_html=True)
          with r111:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 30 </h5>" , unsafe_allow_html=True)      
     ...
     with l12:
          ...
          with l121:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حماه </h5>" , unsafe_allow_html=True)
          with r121:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 27 </h5>" , unsafe_allow_html=True)      
     ...
     with l13:
          ...
          with l131:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع:  دير الزور سابقاً/ على طريق دمشق درعا حالياً  </h5>" , unsafe_allow_html=True)
          with r131:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 19 </h5>" , unsafe_allow_html=True)      
     ...
     with l14:
          ...
          with l141:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: طرطوس </h5>" , unsafe_allow_html=True)
          with r141:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 9 </h5>" , unsafe_allow_html=True)      
     ...
     with l15:
          ...
          with l151:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حمص  </h5>" , unsafe_allow_html=True)
          with r151:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 17 </h5>" , unsafe_allow_html=True)      
     ...
     with l16:
          ...
          with l161:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب </h5>" , unsafe_allow_html=True)
          with r161:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 34 </h5>" , unsafe_allow_html=True)      
     ...
     with l17:
          ...
          with l171:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: دمشق، اللاذقية </h5>" , unsafe_allow_html=True)
          with r171:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 14 </h5>" , unsafe_allow_html=True)      
     ...
     with l18:
          ...
          with l181:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: أوتوستراد دمشق-درعا </h5>" , unsafe_allow_html=True)
          with r181:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 28 </h5>" , unsafe_allow_html=True)      
     ...
     with l19:
          ...
          with l191:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: اللاذقية  </h5>" , unsafe_allow_html=True)
          with r191:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 16 </h5>" , unsafe_allow_html=True) 
     ...
     with l20:
          ...
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: ريف دمشق  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 21 </h5>" , unsafe_allow_html=True) 
     ...
     l20, r20=st.columns((4,1))
     with r20:
          ZUimage= Image.open("images/ZU.webp")
          st.image(ZUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة الزهراء </h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب، جرابلس  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: لا يوجد </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://alzahraa.university/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>alzahraa.university</a>", unsafe_allow_html=True)
               st.write("<a href='ZU' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---")
     l20, r20=st.columns((4,1))
     with r20:
          NPUimage= Image.open("images/NPU.webp")
          st.image(NPUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة الشمال الخاصة </h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: إدلب  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 37 </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://spu-sy.org/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>spu-sy.org</a>", unsafe_allow_html=True)
               st.write("<a href='ZU' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---")
     l20, r20=st.columns((4,1))
     with r20:
          NPUimage= Image.open("images/MPU.webp")
          st.image(NPUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة ماري الخاصة </h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: إدلب  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: لايوجد </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://mari-university.web.app/#/login' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>mari-university.web.app</a>", unsafe_allow_html=True)
               st.write("<a href='MPU' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---")
     l20, r20=st.columns((4,1))
     with r20:
          NPUimage= Image.open("images/SHPU.webp")
          st.image(NPUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة الشام </h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 36 </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://shamuniversity.com/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>shamuniversity.web.app</a>", unsafe_allow_html=True)
               st.write("<a href='SHPU' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
     ...
     with l20:
          ...
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : الحدود السورية التركية لكنها تختص بالتعليم عن بعد  </h5>" , unsafe_allow_html=True)
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 33 </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://ziu-university.net' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>ziu-university.net</a>", unsafe_allow_html=True) 
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
          RUimage= Image.open("images/MAS.jpeg")
          st.image(RUimage)
     with l20:
          ...
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : إدلب  </h5>" , unsafe_allow_html=True)
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 38 </h5>" , unsafe_allow_html=True) 
     ...
     l20, r20=st.columns((4,1))
     with r20:
          NPUimage= Image.open("images/BPU.webp")
          st.image(NPUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة باشاك شهير</h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: لايوجد </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://bs-uni.com/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>bs-uni.web.app</a>", unsafe_allow_html=True)
               st.write("<a href='BPU' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---")
     l20, r20=st.columns((4,1))
     with r20:
          NPUimage= Image.open("images/IUSR.webp")
          st.image(NPUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> الجامعة الدولية للعلوم والنهضة </h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع: حلب  </h5>" , unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'>  ترتيب الجامعة على سوريا: 31 </h5>" , unsafe_allow_html=True) 
               st.write("<a href='https://iusr.university/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>iusr.university</a>", unsafe_allow_html=True)
               st.write("<a href='IUSR' target='_blank' class='.st-emotion-cache-g2ydmt' style='border: 1px solid #00B0F0; border-radius:5px; padding:6px; text-align: right; color:#00B0F0; font-weight: bolder; font-weight: 600; font-size: 1.2rem; text-decoration: none;'> ...اقرأ المزيد </a>", unsafe_allow_html=True)
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
          RUimage= Image.open("images/HUMS.webp")
          st.image(RUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة الحياة للعلوم الطبية</h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : إدلب  </h5>" , unsafe_allow_html=True)
               st.write("<a href='https://www.facebook.com/alhayat.university.m/?locale=ar_AR' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>alhayat.university.</a>", unsafe_allow_html=True)
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
          RUimage= Image.open("images/AUS.webp")
          st.image(RUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'>جامعة آرام</h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : حلب  </h5>" , unsafe_allow_html=True)
               st.write("<a href='https://www.facebook.com/Aramuniversity/?locale=ar_AR' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>Aramuniversity</a>", unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة آرام للعلوم هي مؤسسة خاصة بالتعليم العالي غير ربحية تأسست عام 2016 ورخّصت عام 2018 </h5>" , unsafe_allow_html=True)
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
          RUimage= Image.open("images/AMU.png")
          st.image(RUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'> جامعة المعالي</h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : حلب  </h5>" , unsafe_allow_html=True)
               st.write("<a href='http://students.almaali-univ.org/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>students.almaali-univ.org</a>", unsafe_allow_html=True)
          with r201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> مؤسسة علمية مستقلةأهلية، تُعنى بالتعليم الأكاديمي العالي </h5>" , unsafe_allow_html=True)
     st.write("---") 
     l20, r20=st.columns((4,1))
     with r20:
          RUimage= Image.open("images/SUST.jpeg")
          st.image(RUimage)
     with l20:
          st.markdown("<h2 style='text-align: right; color: #00B0F0; font-weight:bold;'>الجامعة السورية للعلوم والتكنولوجيا</h2>" , unsafe_allow_html=True)
          l201,r201=st.columns(2)
          with l201:
               st.markdown("<h5 style='text-align: right; color: #000000;'> الموقع : حلب  </h5>" , unsafe_allow_html=True)
