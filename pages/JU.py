...
st.set_page_config(page_title="College Path- جامعة الجزيرة", page_icon=icon, layout= "wide")
def cost(unicost):
...
with st.sidebar:
    ...
    select = option_menu(
        menu_icon="bank2",
        menu_title="  جامعة الجزيرة الخاصة  ",
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=1aQYeAZnLfjWQoSmOrTnDcatT0mwFCJc&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'> جامعة الجزيرة الخاصة </h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/JU.jpg")
            st.image(image)
        with r:
            st.write("<a href='https://jude.edu.sy/' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/Aljazeera+Private+University/@33.1692136,36.2955347,16.25z/data=!4m9!1m2!2m1!1z2KzYp9mF2LnYqSDYp9mE2KzYstmK2LHYqSDYp9mE2K7Yp9i12Kk!3m5!1s0x1519152b9c27432f:0x48400f334f9f3e29!8m2!3d33.1678674!4d36.3024762!16s%2Fg%2F11hdqxnkwp?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 20 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة الجزيرة الخاصة هي جامعة سورية خاصة مقرها مدينة دير الزور . أُنشأت عام 2007 بهدف تقديم خدمات التعليم الجامعي وما بعد الجامعي للمنطقة الشرقية من سوريا، انتقلت الجامعة منذ بدء الحرب إلى طريق دمشق درعا </h5>" , unsafe_allow_html=True)  
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.youtube.com/channel/UCChCNHhwvrAPc43160NJ0GA' style='text-align: right; color: #f02020; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  YouTube-يوتيوب 🟥 </a>", unsafe_allow_html=True)
        st.write("<a href='https://m.facebook.com/jude.edu.sy/' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
    if selectuni=="الرسوم الدراسية":
        ...
        for loop in range(29):
            ...
            allfees.append(l)
        list=[]
        majors=["طب الأسنان","الصيدلة","الهندسة المدنية","الهندسة المعلوماتية","إدارة الأعمال","هندسة العمارة"]
    ...
    if selectuni=="كليات الجامعة":
        ...
        st.markdown("<h4 style='text-align: right; color: #000000;'> كلية الهندسة المدنية </h4>" , unsafe_allow_html=True)
