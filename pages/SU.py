...
st.set_page_config(page_title="College Path- جامعة الشهباء", page_icon=icon, layout= "wide")
def cost(unicost):
...
if select=="على الخريطة":
    ...
    st.write("###")
    gmap="""<p><iframe src="https://www.google.com/maps/d/embed?mid=19mDd9TTlCTHG9xpWExaG8F4nBhq7qjE&ehbc=2E312F" width="100%" height="600" style="border:10;" allowfullscreen="True" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>"""
    st.markdown(gmap, unsafe_allow_html=True)
if select=="معلومات عن الجامعة":
    st.write("###")
    st.markdown("<h2 style='text-align: right; color: #00B0F0;'>جامعة الشهباء</h2>" , unsafe_allow_html=True)
    st.write("###")
    ...
    if selectuni=="نظرة عامة":
        l,r= st.columns(2)
        with l:
            image=Image.open("pictures/SU.jpg")
            st.image(image)
        with r:
            st.write("<a href='http://su.edu.sy/ar/home' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع الإلكتروني🌐 </a>", unsafe_allow_html=True)
            st.write("<a href='https://www.google.com/maps/place/%D8%AC%D8%A7%D9%85%D8%B9%D8%A9+%D8%A7%D9%84%D8%B4%D9%87%D8%A8%D8%A7%D8%A1+%D8%A7%D9%84%D8%AE%D8%A7%D8%B5%D8%A9+%D8%A7%D9%84%D9%85%D8%A8%D9%86%D9%89+%D8%A7%D9%84%D8%AC%D8%AF%D9%8A%D8%AF%E2%80%AD/@36.2042696,37.0862641,16.75z/data=!4m10!1m2!2m1!1z2KzYp9mF2LnYqSDYp9mE2LTZh9io2KfYoSDYp9mE2K7Yp9i12Kk!3m6!1s0x152559efe3a219a5:0xf3349914d48da9d8!8m2!3d36.2042115!4d37.0909186!15sCibYrNin2YXYudipINin2YTYtNmH2KjYp9ihINin2YTYrtin2LXYqZIBCnVuaXZlcnNpdHngAQA!16s%2Fg%2F11smcsdwfb?authuser=0&entry=ttu' style='text-align: right; color: #0070C0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'> الموقع على الخريطة🗺  </a>", unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> نوع الجامعة : خاصة </h5>" , unsafe_allow_html=True)
            st.markdown("<h5 style='text-align: right; color: #000000;'> ترتيب الجامعة على سوريا حسب ويبوميتريكس : 30 </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> نبذة عن الجامعة </h2>" , unsafe_allow_html=True)
        st.markdown("<h5 style='text-align: right; color: #000000;'> جامعة الشهباء الخاصة هي جامعة خاصة في سوريا، أُنشئت عام 2005، كانت تعرف باسم «جامعة الخليج» حتى فبراير من العام 2012، حيث تم تغيير اسمها ليصبح «جامعة الشهباء».أبرمت جامعة الشهباء عند تأسيسها اتفاقيات تعاون أكاديمي مع جامعتي جورج ماسون وبنتلي </h5>" , unsafe_allow_html=True)
        st.write("---")
        st.markdown("<h2 style='text-align: right; color: #00B0F0;'> صفحات الجامعة على مواقع التواصل </h2>" , unsafe_allow_html=True)
        st.write("<a href='https://www.facebook.com/AlshahbaaUnV' style='text-align: right; color: #0030f0; font-weight: bolder; font-weight: 600; font-size: 1.2rem;'>  Facebook-فيسبوك 🟦 </a>", unsafe_allow_html=True)
    if selectuni=="الرسوم الدراسية":
        ...
        for loop in range(44):
            ...
            allfees.append(l)
        list=[]
        majors=["طب الأسنان","هندسة الحواسيب والاتصالات المحمولة","إدارة الأعمال","هندسة العمارة","إدارة التسويق"]
    ...
    if selectuni=="كليات الجامعة":
        ...
        st.markdown("<h4 style='text-align: right; color: #000000;'> كلية هندسة المعلومات </h4>" , unsafe_allow_html=True)
        st.markdown("<h4 style='text-align: right; color: #000000;'> كلية الإدارة والأعمال </h4>" , unsafe_allow_html=True)